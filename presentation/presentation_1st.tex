...
% Title metadata
% ------------------------------------------------------------
\titlegraphic{\includegraphics[height=1.5cm]{vu_logo.png}}
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{column}{0.64\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{detect_stage_speedups_graph.png}

    \vspace{1pt}
    {\tiny
    Overall pipeline: \(1.13\times\) \quad \(\mid\) \quad
    Detect stage: \(S = 8.39\times\) \quad \(\mid\) \quad
    \(P \approx 0.944\)
    }
...
\scriptsize
\textbf{Finding:} INVINCIBLE broadcasts AIS pings 6\,715 nm apart within minutes,
which is physically impossible and strongly supports identity cloning.
\end{beamercolorbox}
